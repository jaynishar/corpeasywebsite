...
<h4 class="text-lg sm:text-xl font-bold text-slate-900 mb-3">Financial District Status</h4>
...
<h4 class="text-lg sm:text-xl font-bold text-slate-900 mb-3">Connectivity</h4>
...
<h4 class="text-lg sm:text-xl font-bold text-slate-900 mb-3">Grade A Buildings</h4>
...
<div><h4 class="text-lg font-bold text-slate-900 mb-1">CAM Charges Are Steep</h4><p class="text-slate-600 leading-relaxed">Common Area Maintenance in BKC ranges from ₹25 to ₹40 per sq ft per month. On a 5,000 sq ft office, that is ₹1.25-2 lakh per month on top of rent. Always ask for the total cost of occupancy, not just the base rent. CAM covers lobby maintenance, lift operations, security, and common area utilities.</p></div>
</div>
<div class="glass-card p-6 flex items-start gap-4">
...
<div><h4 class="text-lg font-bold text-slate-900 mb-1">Parking Is a Premium</h4><p class="text-slate-600 leading-relaxed">Parking in BKC commercial buildings costs ₹10,000 to ₹15,000 per spot per month. Most buildings allocate 1 spot per 1,000-1,500 sq ft. If you need additional spots, negotiate them into the lease before signing — adding them later is expensive or impossible.</p></div>
</div>
<div class="glass-card p-6 flex items-start gap-4">
...
<div><h4 class="text-lg font-bold text-slate-900 mb-1">Deposit Negotiation</h4><p class="text-slate-600 leading-relaxed">Standard security deposit in BKC is 4-6 months rent (interest-free). On a ₹15 lakh/month office, that is ₹60-90 lakh locked up. Some landlords start at 6 months — we typically negotiate this down to 4 months for our clients, freeing up working capital.</p></div>
</div>
<div class="glass-card p-6 flex items-start gap-4">
...
<h4 class="text-lg font-bold text-slate-900 mb-2 group-hover:text-brand-electric transition-colors">Office Space in Lower Parel</h4>
